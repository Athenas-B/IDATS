...
public class Novy extends javax.swing.JPanel {
    ...
    public Novy(IObyvatele obyvatele) {
        initComponents();
        this.obyvatele = obyvatele;
        cmbPozice.setModel(new DefaultComboBoxModel(enumPozice.values()));
        if (obyvatele.vratNazvyKraju() == null) {
            cmbKraj.setModel(new DefaultComboBoxModel());
        } else {
            cmbKraj.setModel(new DefaultComboBoxModel(obyvatele.vratNazvyKraju()));
        }
    }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(cmbPozice, javax.swing.GroupLayout.PREFERRED_SIZE, 228, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    private void btnKrajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKrajActionPerformed
        obyvatele.vytvorKraj(txtKraj.getText());
        if (obyvatele.vratNazvyKraju() == null) {
            cmbKraj.setModel(new DefaultComboBoxModel());
        } else {
            cmbKraj.setModel(new DefaultComboBoxModel(obyvatele.vratNazvyKraju()));
    ...
    private void btnObecActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnObecActionPerformed
        if (!txtObec.getText().isEmpty() && cmbKraj.getSelectedIndex() != -1) {
            ...
            obyvatele.vlozObec(obec, (enumPozice) cmbPozice.getSelectedItem(), cmbKraj.getSelectedIndex() + 1);
        }
